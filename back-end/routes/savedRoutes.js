...
import verifyToken from '../middlewares/verifyToken.js'; // ✅ FIXED: was '../middlewares/verifyToken.js' (plural) — actual folder is 'middleware' (singular), caused crash on startup
