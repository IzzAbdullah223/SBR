  ...
  try {
    ...
    if (
      ...
      return res.status(404).json({
        ...
        errorCode: 'NO_ROUTES',
        message:
          'Bus stops were found near both locations, but no routes connect them. Try locations along major roads like Sheikh Zayed Road or Al Wasl Road.',
        debug: {
    ...
    if (allBuses.length === 0) {
      return res.status(404).json({
        ...
        message:
          'Routes were found but no buses are currently running. Dubai RTA buses typically operate from 5:00 AM to 11:30 PM on weekdays.',
        debug: {
